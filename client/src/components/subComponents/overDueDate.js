            ...
            <Container>
                <div className="upcomming-page-container container-fluid">
                    <div className="d-flex align-items-center">
                        ...
                        <span className="ms-4 border fw-bold fs-2 ps-3 pe-3 text-danger">{props.props && props.props.length}</span>
                    </div>
                    <div className="addTask-parent-container border mt-4">
                        <div className="p-4">
                            <div className="mt-3">
                                <div>
                                    {props.props && props.props.length === 0 ? <p>No Delayed Task</p> :
                                       props.props && props.props.map((val) => (
